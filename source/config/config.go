// Package config is the source for config-srv
package config
...
func (o *config) Get(path ...string) Value {
	if !o.loaded() {
		o.sync()
	}
...
func (o *config) Watch(path ...string) (Watcher, error) {
	value := o.Get(path...)
